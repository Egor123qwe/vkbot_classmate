...
def Completed(Message,Id,AllInfo,CheckInfo,GId,vk,Subj,About,Pass,Gid_2): 
    ...
    if CheckInfo[1] == 'All':
        ...
        Code = Message[9:16]
        if (Code == trueCode):
            Result = 'Местоположение: Возле стадиона. За зданием у шлагбаума.' # Под лестницей возле психолога (1 этаж).
        else:
            Result = 'Неверный код...'
...
Commands = [
    ...
    'Создатель: Егор Трухан. 10 "A" класс 2020 год. Версия: Beta 2.4.1. Приятного использования)'
]
About = ''
